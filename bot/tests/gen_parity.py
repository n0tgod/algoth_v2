...
def sit():
    ...
    picks = [
        ...
        {"arm": "gbm", "hour": h_a, "ver": 3, "at_ts": ts_a + 5400,
         ...
         "long": [{"sym": "BBBUSDT", "px": 0.031, "fwd": 30.0,
                   ...
                   "scan": True}],
         "short": []},
        # Нулевая длительность: сканер закрыл её в ту же СЕКУНДУ, в
        # которую открыл. На этом случае касса текла — свой выход шёл
        # раньше своего входа, деньги считались от нуля и не
        # возвращались никому.
        {"arm": "gbm", "hour": h_a, "ver": 3, "at_ts": ts_a + 5401,
         "scan": True,
         "long": [{"sym": "EEEUSDT", "px": 4.2, "fwd": 28.0,
                   "mae": -12.0, "at_ts": ts_a + 5400.5,
                   "scan": True}],
         "short": []},
        # Встречный сигнал по имени с открытой позицией: площадка
        # схлопнула бы позицию, а не открыла вторую. Лот AAA закрыт
        # ЭТОЙ ценой, а сам сигнал позиции не открывает.
        {"arm": "gbm", "hour": h_a, "ver": 3, "at_ts": ts_a + 5000,
         "scan": True, "long": [],
         "short": [{"sym": "AAAUSDT", "px": 51.0, "fwd": -30.0,
                    "mae": 12.0, "at_ts": ts_a + 5000, "scan": True}]},
    ...
    reviews = [
        ...
        # Выход нулевой сделки — та же секунда, что её вход.
        {"arm": "gbm", "hour": h_a, "cost_bp": 11.0,
         "at_ts": ts_a + 5402.0,
         "rows": [{"sym": "EEEUSDT", "side": "long",
                   "expected": 28.0, "got": -18.0,
                   "net": -18.0 - 11.0, "exit_hour": h_a,
                   "reason": "цена прошла обещанный ход против",
                   "live": True, "exit_ts": ts_a + 5400.5}]},
