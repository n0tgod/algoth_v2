...
- L457 `MIN_AGE_DAYS = {'pair_safe': 7.0, 'pair_optimal': 7.0,…` — ВОЗРАСТ ИМЕНИ на входе короткой стороны — решение владельца 2026-09-08 («объявляй»), объявленное ДО следующег…
