...
подделку к копии файла, гоняет тесты и требует падения. Журналов
машина отсюда не пишет (`check_build`, а не `check_role`): суд и
запись — разные дела, и 03.09 совмещение уже положило лишнюю строку в
живую очередь механик.

    .venv/bin/python research/mech_258a860c/controls_check.py
"""
import json
import os
import sys
