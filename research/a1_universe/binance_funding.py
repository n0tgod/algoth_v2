...
def summarize(rows):
    ...
    # Число начислений в сутки берётся из самого ряда: Binance менял
    # интервал у части инструментов с 8 часов на 4, и константа «три
    # раза в сутки» дала бы неверный годовой ориентир.
