...
то, что свёртка выбрасывает). Свободного места на 11–13 суток записи,
значит сворачивать надо раньше, чем сырьё состарится, а не «когда дойдут
руки».
...
def write_report(path=None, store=None, log=log_):
    ...
    if miss:
        ...
        L.append("\nСырьё стареет и удаляется вместе с диском: каждые "
                 "несвёрнутые сутки — это лесенка, которой больше не "
                 "будет нигде.\n")
