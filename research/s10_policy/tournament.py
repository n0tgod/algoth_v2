...
граница); скидка, взведение и правила v11 живого сканера (запас
против шума, потолок съеденного обещания) не реплеятся (одинаково у
...
# Правила книги сменились (гейт 22 → 33, зонд крайности): референсом
# служит ячейка e33 — пространство вариантов объявлено спекой и не
# растёт, а 33 в нём есть с первого дня.
CURRENT = "e33_rr2.0_sq_t1_a24"
...
def report(legs, cells, wf, path):
    ...
    lines = [
        ...
        f"прежний",
        "- оценка ОПТИМИСТИЧНА: веса видели эти часы; скидка, "
        "взведение и правила v11 сканера не реплеятся. "
        "Верхняя граница, не бэктест",
