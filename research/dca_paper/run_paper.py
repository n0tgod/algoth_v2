...
# Шапка кончается СВОИМ разделителем — ровно как строка значений
# (`conc_cells`): без него соседняя колонка склеивалась с этой, и
# таблица теряла столбец молча, а не ломалась.
