...
`test_guard_sister.py`, файл восстанавливается и сверяется по sha256.
...
SUITE = "research/mech_a47008e1/test_guard_sister.py"
...
def main():
    ...
    for i, c in enumerate(controls, 1):
        ...
        if fell:
            ...
            print(f"{i:2d}. кусается ({round(time.time() - t0, 1)} с): {want}")
