...
REF = "e:fav"                              # нынешнее правило книги
...
def report(s):
    ...
    P = ["# D8 — тейк DCA-книги: сетка правил", "",
         ...
         f"Нынешнее правило (`{ref}`) — цена `вход · (1 + mfe)`, "
         "**неподвижная** и привязанная к цене базы: ТВХ едет вниз с "
         "каждым доливом, цель за ней не идёт. Сетка объявлена ДО "
