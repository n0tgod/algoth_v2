...
# Ставка поддерживающей маржи, когда тиров у имени НЕТ (делистнутая нога,
# новый листинг без таблицы): §10, модальная ставка площадки. Живёт здесь,
# потому что её берут и замеры лестницы, и страница графика, а два числа
# под одним именем однажды разойдутся.
FLAT_MMR = 0.02
