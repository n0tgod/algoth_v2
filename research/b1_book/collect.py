...
#
# Состав тот же, на котором считались зонды T1, T2 и T4 (шестнадцать
# имён). Это не вкус: живой сбор и архивные замеры тогда сравнимы прямо,
# а не «примерно про то же». Расширение вдвое покупает вдвое больше
# бумажных сделок в сутки — а число наблюдений и есть то, чего всем
# гипотезам не хватало.
