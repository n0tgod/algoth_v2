...
function pairBlock(b){
  ...
  let h = "<div class=panel><div class=cap>общий счёт: две стороны, одна " +
    "касса</div>" + (b.one_sided ? "<p class=bad><b>Одной стороны в книге " +
    "НЕТ</b> (" + esc(b.one_sided.join(", ")) + "): числа этой книги " +
    "описывают половину замысла, а выглядят как целая книга. Читать их " +
    "нельзя, пока сторона не появится.</p>" : "") + "<p class=dim>Депозит ОДИН на обе стороны: занятая одной " +
